% Example with random initial condition and no structure, square
...
p.runname = 'example_initial_condition.mat'; %     p.runname:       Character string naming the run. If specified
