 /*
 * =============================================================
 * mexD8Dir.c - C MEX file to compute drainage area
 *
 * usage: [D, minima, flooded] = mexD8(M,dy/dx,sinks,bvec,flood)
 *
 *    Input arguments:
 ...
 *
 *    Return arguments: 
 *      D:      a K x J array of D8 drainage directions
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    mxArray *Mptr, *Basinptr, *minimaIdxptr;
    double *M, *Mfl, *Basin, *minimaIdx, *D, *F, *minima, *a, *fl, *b, *s, zppmin;
    ...
    minimaIdx = (double *)mxGetPr(minimaIdxptr= mxCreateDoubleMatrix(K, J, mxREAL)); // minima
    D = (double *)mxGetPr(plhs[0]= mxCreateDoubleMatrix(K, J, mxREAL)); // matrix of D8 drainage directions
...
//     // The weights array
//     W = (double *)mxGetPr(Wptr= mxCreateNumericArray(ndims, dims, mxDOUBLE_CLASS, mxREAL));
// 
